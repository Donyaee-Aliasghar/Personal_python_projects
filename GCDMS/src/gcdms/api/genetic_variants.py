...
from gcdms.schemas import GeneticVariant as sGeneticVariant, GeneticVariantCreate as sGeneticVariantCreate
from gcdms.crud import create_genetic_variants
